...
<div class="d-flex">
    <div class="sidebar hijau-toska-gelap" style="width: 240px;">
        ...
        <nav class="mt-3">
            ...
            <a href="{{ route('admin.artikel.index') }}" class="nav-link-item {{ request()->routeIs('admin.artikel.*') ? 'active' : '' }}">
                <i class="bi bi-newspaper me-2"></i> Artikel
            </a>
            <a href="{{ route('admin.produk.index') }}" class="nav-link-item {{ request()->routeIs('admin.produk.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.galeri.index') }}" class="nav-link-item {{ request()->routeIs('admin.galeri.*') ? 'active' : '' }}">
                <i class="bi bi-images me-2"></i> Galeri
            </a>
            <a href="{{ route('admin.profil.edit') }}" class="nav-link-item {{ request()->routeIs('admin.profil.*') ? 'active' : '' }}">
                <i class="bi bi-building me-2"></i> Profil Perusahaan
            </a>
            <hr class="border-light border-opacity-25 mx-3">
            <a href="{{ url('/') }}" class="nav-link-item" target="_blank">
    ...
    <div class="flex-grow-1">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            ...
            <span class="text-muted small">Halo, {{ session('admin_name') }}</span>
        </nav>
