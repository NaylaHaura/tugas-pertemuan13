...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kategori" value="<?php echo e(old('kategori')); ?>" class="form-control <?php $__errorArgs = ['kategori'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="link_eksternal" value="<?php echo e(old('link_eksternal')); ?>" placeholder="https://..." class="form-control <?php $__errorArgs = ['link_eksternal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\lessential\resources\views/admin/produk/create.blade.php ENDPATH**/ ?>