        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/artikel')); ?>">Artikel</a> </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/contact')); ?>">Contact</a> </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/galeri')); ?>">Galeri</a> </li>
                </ul>
            </div>
        </div>
    </nav>
...
</html><?php /**PATH C:\laragon\www\lessential\resources\views/layouts/app.blade.php ENDPATH**/ ?>